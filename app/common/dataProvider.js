...
var DataProvider = (function () {
    ...
    DataProvider.prototype.getConnection = function () {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, oracledb.getConnection('country-code')];
                    case 1:
                        conn = _a.sent();
                        resolve(conn);
                        return [3, 3];
    ...
    DataProvider.prototype.shutdown = function () {
        var _this = this;
        var result = new Promise(function (resolve, reject) {
            try {
                if (_this.didShutdown) {
                    return resolve();
                }
                _this.didShutdown = true;
