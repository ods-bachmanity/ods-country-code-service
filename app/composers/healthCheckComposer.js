...
var HealthCheckComposer = (function (_super) {
    __extends(HealthCheckComposer, _super);
    function HealthCheckComposer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HealthCheckComposer.prototype.fx = function (args) {
        var _this = this;
        var result = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var db, connection_1, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        connection_1.ping(function (err) {
                            if (err) {
                                return reject({
                                    successful: false,
                            ...
                            _this.executionContext.raw = Object.assign({}, {
                                HealthCheck: "OK",
                                Message: "No Rest for Old Men",
                                Database: "Oracle " + connection_1.oracleServerVersionString
                            });
                            connection_1.close();
                            return resolve({
                                successful: true
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.error("HealthCheckSchematic: " + err_1);
                        return [2, reject({
                                successful: false,
                                message: "" + err_1,
                                httpStatus: 500
